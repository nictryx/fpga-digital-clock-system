...
1. The FPGA clock is divided to generate the required timing intervals.
2. Counters track seconds, minutes, hours, days, months, and years.
3. The time and date values automatically roll over when their limits are reached.
4. Board inputs are used to select the display mode and modify individual values.
5. The selected time or date values are converted and multiplexed across the eight-digit seven-segment display.
